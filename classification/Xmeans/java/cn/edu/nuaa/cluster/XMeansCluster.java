...
public class XMeansCluster {
	 ...
	 */
	private DistanceFunction distanceF = new ManhattanDistance();//new ChebyshevDistance();//new FilteredDistance();//new MinkowskiDistance();//new ManhattanDistance();//new EuclideanDistance();
	...
	private int maxNumClusters = 10000;
	private int minNumClusters = 100;
	private int seed = 1;
	
	public static void main(String[] args) throws Exception {
		String featureFile = "./in/cluster data.txt";
		String arffFile = "./output/XMeans_results/input.arff";
		String clusterResults = "./output/XMeans_results/result.txt";
